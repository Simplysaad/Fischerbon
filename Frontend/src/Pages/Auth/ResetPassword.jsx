...
<<<<<<< HEAD
  ...
  const validateForm = () => {
    const newErrors = {};
    if (!passwords.newPassword.trim()) newErrors.newPassword = 'Password is required';
    if (!passwords.confirmPassword.trim()) newErrors.confirmPassword = 'Password is required';
=======
  const [alert, setAlert] = useState("");
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <div className="relative">
              ...
              />
              <span
                onClick={() => setPasswords((prev) => ({ ...prev, showPassword: !prev.showPassword }))}
                className="absolute right-3 top-10 cursor-pointer text-accent"
              >
                {passwords.showPassword ? <EyeOff size={20} /> : <Eye size={20} />}
              </span>
            </div>
...
<<<<<<< HEAD
          ...
          <div>
            <div className="relative">
              ...
              />
              <span
                onClick={() => setPasswords((prev) => ({ ...prev, showConfirmPassword: !prev.showConfirmPassword }))}
                className="absolute right-3 top-10 cursor-pointer text-accent"
              >
                {passwords.showConfirmPassword ? <EyeOff size={20} /> : <Eye size={20} />}
              </span>
            </div>
