...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`sticky min-h-screen inset-y-0 left-0 bg-white shadow-md w-64 transform transition-transform duration-200 ease-in-out z-20
      ...
      >
        <div className="flex flex-col h-full">
          {/* <div className="flex items-center justify-center h-16 border-b border-gray-200 px-6">
            <h1 className="text-xl font-bold text-blue-600 select-none"></h1>
          </div> */}
